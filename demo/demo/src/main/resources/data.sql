...
INSERT INTO verification_token (id, expiry_date, token, user_id) VALUES ('1', '2018-12-12', 'token', '1');
...
INSERT INTO verification_token (id, expiry_date, token, user_id) VALUES ('2', '2018-12-12', 'token2', '2');

INSERT INTO FRIEND_REQUEST(id,status,receiver_user_id,sender_user_id) VALUES (1,1,2,1);
